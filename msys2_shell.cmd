...
if not defined MSYS2_NOSTART (
  ...
  "%WD%mintty" -i /msys2.ico -t "%CONTITLE%" /usr/bin/zsh --login %1 %2 %3 %4 %5 %6 %7 %8 %9
)
exit /b %ERRORLEVEL%
...
if not defined MSYS2_NOSTART (
  ...
  "%ComEmuCommand%" /Here /Icon "%WD%..\..\msys2.ico" /cmd "%WD%zsh" --login %1 %2 %3 %4 %5 %6 %7 %8 %9
)
exit /b %ERRORLEVEL%
...
set MSYSCON=
if not defined MSYS2_NOSTART (
  start "%CONTITLE%" "%WD%zsh" --login %1 %2 %3 %4 %5 %6 %7 %8 %9
) else (
...
:printhelp
echo Usage:
echo     %~1 [options] [shell parameters]
echo.
echo Options:
...
echo                                      return shell resulting errorcode as
...
echo following parameters are passed as shell command parameters.
echo.
exit /b 0
